package panchat.messages.extras;
...
public class FileBlockMessage implements Serializable, Message.Unicast {
	...
	public FileBlockMessage(FileMessage pFile, long pBlockNum, boolean readData) {
		file = pFile;
		blockNum = pBlockNum;
		if (readData) {
			try {
	...
	public boolean equals(Object obj) {
		if (obj instanceof FileBlockMessage) {

			FileBlockMessage bloqueObj = (FileBlockMessage) obj;
	...
	public String toString() {
		return "Fichero : " + this.file + " numero_bloque : " + this.blockNum;
	}
}
