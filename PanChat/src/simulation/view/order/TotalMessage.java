...
public class TotalMessage implements VectorI,Serializable{
	...
	private static final long serialVersionUID = 1L;
		...
		public static final int Y_PAINT_FINAL = SimulationView.cellHeight-Y_PAINT_ORIGIN;
		...
		public void draw(Graphics2D g) {
			...
			if(isOrigin){
				...
				xDraw = (tick+1) * SimulationView.cellWidth + SimulationView.paddingX
				- X_PAINT_FINAL;
				//-2 es para que no quede justo en la linea
				yDraw = process * (SimulationView.cellHeight + SimulationView.paddingY)
				+ SimulationView.paddingY + Y_PAINT_ORIGIN + Y_PAINT_FINAL - 2;
			}
