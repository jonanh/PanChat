...
public class OptionsMenu extends JPanel {
	...
	private static final String imagePath = "/simulation/icons/";
	...
	public void setImages() {
		...
		showSimulationPanelButton.setText("mostrar simulacion");

		createCutButton.setText("crear corte");
	...
	public JCheckBox getNoneCheck() {
		return noneCheck;
	}

	public JTextField getNumProcessText() {
		return numProcessText;
	}

	public JTextField getTimeUnitText() {
		return timeUnitText;
	}
	...
	public JButton getMoveSLButton() {
		return moveSLButton;
	}

	public JButton getShowEventPanelButton() {
		return showEventPanelButton;
	}

	public JButton getShowCutPanelButton() {
		return showCutPanelButton;
	}

	public JButton getShowSimulationPanelButton() {
		return showSimulationPanelButton;
	}

	public JButton getShowSnapshotPanelButton() {
		return showSnapshotPanelButton;
	}

	public InformationCanvas getCanvas() {
		return canvas;
	}
